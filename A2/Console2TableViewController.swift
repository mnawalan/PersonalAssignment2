//
//  Console2TableViewController.swift
//  A2
//
...
class Console2TableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "\(wiiLibrary[indexPath.row])"
